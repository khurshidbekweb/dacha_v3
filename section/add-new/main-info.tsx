                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Input placeholder="Honalar soni" {...field} />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )}
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Input placeholder="1 o`rinli yotoqlar soni" {...field} />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )}
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Input placeholder="2 o`rinli yotoqlar soni" {...field} />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )}
                        ...
                        <FormItem>
                            ...
                            <FormControl>
                                <Cleave
                                    ...
                                    name="phonenumber"
                                    inputMode="numeric"
                                    onChange={(e) => setCottage({ ...cottage, contactPhone: e.target.value.replace(/\D/g, "") })}
                                    required
                                />
                            </FormControl>
                            <FormMessage />
