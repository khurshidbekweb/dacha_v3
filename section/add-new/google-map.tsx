...
export const DachaMap = ({ setCottage, cottage }: infoProps) => {
    ...
    return (
        <Drawer onOpenChange={setOpen} open={open}>
            <DrawerTrigger className="w-full flex  z-50 items-center gap-x-3 border rounded-lg justify-center p-[6px] cursor-pointer bg-transparent dark:bg-input/30 border-amber-500 text-amber-500"><MapPinned size={25} className="text-amber-600" /> {t('choos_map')}</DrawerTrigger>
