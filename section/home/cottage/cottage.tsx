...
const Cottage = () => {
    ...
    const allCottages = cottages?.filter(dacha => dacha.cottageType[0].id === 'c4c301b1-4719-499e-bde2-2c36715fae9e').slice(8)
    const allCottagesMini = cottages?.filter(dacha => dacha.cottageType[0].id === 'c4c301b1-4719-499e-bde2-2c36715fae9e')
    return (
