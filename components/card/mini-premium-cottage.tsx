...
export function MiniPremiumDacha({ dacha }: premiumCottageProps) {
    ...
    return (
        <div className="max-w-[200px] md:w-[320px] overflow-hidden transition-shadow p-0 relative flex flex-col" key={dacha.id}>
            ...
            <div className="absolute top-3 left-3 flex md:gap-x-2 items-center rounded-full p-1 text-yellow-500 bg-[#ffffff76]">
                <Crown size={20} />
                <p className="text-[12px] md:text-[18px]">Premium</p>
            </div>
        </div>
    );
}